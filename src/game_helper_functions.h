...
/// @returns String
String convertBitfieldToLetter_ColorMatch(unsigned char pad){
...
void updateTouchpadLights(const unsigned char TOUCHPADS[][2][2], unsigned char touchpadsColor[]){
...
void updateTouchpadLights(const unsigned char TOUCHPADS[][3][2], unsigned char touchpadsColor[]){
  hub.SetLights(hub.LIGHT_LEFT, TOUCHPADS[0][touchpadsColor[0]][0],
                TOUCHPADS[0][touchpadsColor[0]][1], 0);
  hub.SetLights(hub.LIGHT_MIDDLE, TOUCHPADS[1][touchpadsColor[1]][0],
                TOUCHPADS[1][touchpadsColor[1]][1], 0);
